...
public class ARImageGalleryAdapter extends BaseAdapter /*implements OnClickListener*/ {
	...
	private ArrayList<ARImageGalleryModel> mImageGallerySubcategories;
	private final boolean mIsLayoutOnTop;

	public ARImageGalleryAdapter(Context context,
								 ArrayList<ARImageGalleryModel> imageGallerySubcategories, boolean isLayoutOnTop) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (type == TYPE_ONE_COLUMN) {
			...
			ARImageGalleryModel model1 = mImageGallerySubcategories.get(position * 2);
			...
			ARImageGalleryModel model2 = mImageGallerySubcategories.get(position * 2 + 1);
